...
// Busca o histórico de valores extras com a descrição e valor
...
$sinalMoeda = "R$"; // Padrão caso não ache nada
...
<?= $sinalMoeda ?> <?= number_format($ganhos,2,",",".") ?>
</p>
</div>
...
<?= $sinalMoeda ?> <?= number_format($gastos,2,",",".") ?>
</p>
</div>
...
<p class="value-medium">
<?= $sinalMoeda ?> <?= number_format($saldoFinal,2,",",".") ?>
</p>
</div>
...
<td><?= $sinalMoeda ?> <?= number_format($gasto["valor"],2,",",".") ?></td>
...
<td style="color: #10b981;"><?= $sinalMoeda ?> <?= number_format($extra["valor"],2,",",".") ?></td>
